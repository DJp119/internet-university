        ...
        <div className="flex flex-wrap items-center justify-center gap-4 mb-12">
          ...
          <div className="flex items-center gap-2.5 bg-white px-5 py-3 rounded-2xl shadow-lg border border-[#FECDD3] hover:shadow-xl hover:scale-105 transition-all duration-300 cursor-pointer">
            ...
            <div>
              ...
              <div className="text-xs text-gray-500">Ad-free forever</div>
            </div>
          </div>
        </div>
      ...
      <section className="relative max-w-6xl mx-auto px-4 pb-16">
        <div className="relative bg-gradient-to-br from-[#E11D48] via-[#FB7185] to-[#2563EB] rounded-[2.5rem] p-12 text-center text-white overflow-hidden shadow-2xl">
          ...
          <div className="relative">
            ...
            {/* CTA Button */}
            <div className="mt-8">
              <Link href="#degrees" className="bg-white text-[#E11D48] px-8 py-4 rounded-full text-lg font-black shadow-2xl hover:shadow-[0_0_40px_rgba(255,255,255,0.3)] hover:scale-105 transition-all duration-300 cursor-pointer">
                Start Your Journey →
              </Link>
            </div>
          </div>
        ...
        <div className="grid sm:grid-cols-3 gap-6">
          {[
            ...
            },
            {
              name: 'Meera S.',
              degree: 'Meme Lord',
              quote: 'My friends couldn\'t believe this was real. Best $1 I\'ve ever spent!',
              avatar: '👩‍🎨',
              rating: 5,
            },
            {
